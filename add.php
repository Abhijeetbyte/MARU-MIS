        ...
        <div class="container mx-auto flex flex-wrap p-5 flex-col
            ...
            <nav class="md:ml-auto flex flex-wrap items-center text-base
                ...
                <nav class="md:ml-auto flex flex-wrap items-center text-base
                 ...
                 <button  onclick="window.location.href='about.php';" class="mr-5 inline-flex items-center bg-blue-500 border-0 py-1 px-3 focus:outline-none hover:bg-blue-900 rounded text-white text-base mt-4 md:mt-0">About us
                </button>
            ...
            <div class="flex flex-col w-full mb-20">
                ...
                <form method="post" action="">
                    ...
                    <div class="relative mb-4">
                        ...
                        <textarea id="remark" name="remarks" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"  placeholder="Write something..."></textarea>
                    </div>
